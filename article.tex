...
\begin{figure}[h]
    ...
    \caption{TODO: add a caption the explains what the connection between concepts in lexi is and how words are selected and culled - what is a concept. Reference the Lexi proceedures followed too}
    \label{fig:lexi}
\end{figure}
